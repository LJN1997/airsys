...
<div class="head">
    ...
    <div class="head-bottom">
        <div class="head-img">
        <img src="https://turkishairlines.ssl.cdn.sdlmedia.com/636807091249123590KU.png" alt="">
        </div>
    ...
    <div class="background-center-box">
        ...
        <div class="back-test-box buff1-box">
            <div class="back-text-top">
                ...
                <label><input type="radio" value="1" name="aa" class="abcd">往返</label>
                </div>
                <div class="back-text-top-input ij"style="border: 1px solid red;">
                    <label><input type="radio"value="1" name="aa" class="abcd" checked>单程</label>
                </div>
            </div>
            <div class="back-text-center">
	            <form action="airsys/users" method="get">
	                <div class="start">
	                    ...
	                    <input type="text" name= "from_city" placeholder="起点">
	                </div>
	                ...
	                <div class="start">
	                    ...
	                    <input type="text" name= "to_city" placeholder="终点">
	                </div>
                ...
                <div class="class">
                    <div class="class-text">
                        <label><input type="radio" checked value="1" name="aa" class="abcd">经济舱</label>
                        <label><input type="radio"  value="1" name="aa" class="abcd">商务舱</label>
                        <label><input type="radio"  value="1" name="aa" class="abcd">头等舱</label>
                    </div>
                    <div class="count">
                        <label><input type="radio" checked value="1" name="aa" class="abcd">成人</label>
                        <label><input type="radio"  value="1" name="aa" class="abcd">儿童</label>
                        <label><input type="radio"  value="1" name="aa" class="abcd">婴儿</label>
                    </div>
                </div>
                <!-- <a href="aaa.jsp"> -->
        ...
        <div class="back-test-box3 buff3-box">
            ...
            <div class="start" style="width: 500px;">
                ...
                <input type="text" placeholder="输入航班号"style="width: 350px;">
            </div>
            <div class="class-id">
            ...
            <div class="enter" style="margin-left: 0px">
                <div class="jiantou">
...
<div class="bottom-size">
    <div class="bottom-a">
    <a href="#">无障碍服务</a>&nbsp;|&nbsp;<a href="#">隐私和Cookie政策</a>&nbsp;|&nbsp;<a href="#">法律公告</a>&nbsp;|&nbsp;<a href="#">乘客权限</a>&nbsp;|&nbsp;<a href="#">EU Data Subjects Rights</a> |&nbsp;Air航空公司版权所有 @1996-2019
    </div>
    </div>
