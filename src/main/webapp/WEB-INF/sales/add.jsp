				...
				<div class="layui-tab-item layui-show">
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="radio" id="man" name="people" value="成人" title="成人" checked> 
							<input type="radio" id="child" name="people" value="儿童" title="儿童">
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="radio" id="grade1" name="grade" value="first_class_remain_seats" title="头等舱"> 
							<input type="radio" id="grade2" name="grade" value="business_class_remain_seats" title="商务舱"> 
							<input type="radio" id="grade3" name="grade" value="economy_class_remain_seats" title="经济舱" checked>
						</div>
					</div>
